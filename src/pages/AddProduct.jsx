            ...
            <div>
              ...
              <div>
                ...
                <div className="flex items-start space-x-2">
                    ...
                    <button
                    type="button"
                    disabled={!name.trim() || loadingDescription}
                    onClick={generateWithQuickBuddy}
                    className="bg-[#0046A5] text-white px-3 py-2 rounded-lg hover:bg-[#00398D] transition text-sm flex items-center space-x-1 disabled:opacity-60"
                    >
                    {loadingDescription ? (
                        ...
                        <>
                        <span>✨</span>
                        <span>Generate with Quick Buddy</span>
                        </>
                    )}
                    </button>
                </div>
                <small className="text-gray-500 block mt-1">
                    You can write your own or let Quick Buddy generate one.
                </small>
                </div>
              {/* Image Upload */}
